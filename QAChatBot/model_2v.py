...
DB_FAISS_PATH = "/content/drive/MyDrive/QAChatBot/LawDoc/db_faiss"
...
Respond with:
**Detailed Answer**: A more comprehensive explanation of answer in minimum 10 sentences and maximum of 15 sentences.
